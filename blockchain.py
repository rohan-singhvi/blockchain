...
class Blockchain(object):
    ...
    def __init__(self):
        ...
        # genesis block—a block with no predecessors. We’ll also need to add a
        # “proof” to our genesis block which is the result of mining (or proof of work).
        # We’ll talk more about mining later.
    ...
    def new_transaction(self, sender, recipient, amount):
        ...
        # a list of transactions, a proof (more on that later), and the hash of the previous Block.
        """
        Creates a new transaction to go into the next mined block.
        :param sender: <str> Address of the sender.
        :param recipient: <str> Address of the recipient.
        :param amount: <int> Amount.
        :return: <int> The index of the blockchain that will hold this transaction.
        """
        ...
        # of the block which the transaction will be added to— the next one to be mined. This will be
        # useful later on, to the user submitting the transaction.
    ...
    def valid_proof(last_proof, proof):
        """
        Validates the proof: Does hash(last_proof, proof) contain the 4 leading zeroes?
    ...
    def hash(block):
        # hashes a block
        """
        Creates a 256-SHA hash of a Block
